...
brain<-readRDS(file="D:/Dropbox (UU)/SSF2_single_cell/comp/Output/Harmony_brain_June_2022/brain_plastic_qc.rds")
...
```{r, fig.width=16}
integrated<- readRDS(file="D:/Dropbox (UU)/SSF2_single_cell/comp/Output/Monocle3_brain_June_2022/brain_noCC_PRPCA2k_25042023_clustered_publ.rds")
