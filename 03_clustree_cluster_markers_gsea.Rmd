...
integrated<-readRDS("D:/Dropbox (UU)/SSF2_single_cell/comp/Output/RPCA_integration_April_2023/brain_plastic_noCC_PRPCA3k_29042023_clustered_publ.rds")
head(integrated)
...
##load_database
mila<-read.csv("c:/Users/mildo141/Dropbox (UU)/SSF2_single_cell/comp/Output/GSEA/Mila_4.csv",header= T)
mila<-as.list(mila[-1,])
